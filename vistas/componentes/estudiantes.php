                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group mb-3">
                                                    <select name="crearPeriodo" id="crearPeriodo" class="form-control" required>
                                                        <option value="0">Elija el periodo academico</option>
                                                        ...
                                                        <option value="QUINTO PERIODO">QUINTO PERIODO</option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group mb-3">
                                                    <select name="editarPeriodo" id="editarPeriodo" class="form-control" required>
                                                        <option value="0">Elija el periodo academico</option>
